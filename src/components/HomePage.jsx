    ...
    const fetchPosts = async () => {
      ...
      for (let index = 0; index < 2; index++) {
        try {
          ...
          // setFollowingPosts(
          //   {
          //     caption: result?.data?.data?.items[0]?.caption?.text,
          //     username: result?.data?.data?.items[0]?.caption?.user?.username,
          //     profilePic:
          //       result?.data?.data?.items[0]?.caption?.user?.profile_pic_url,
          //     userId: result?.data?.data?.items[0]?.caption?.user_id,
          //     commentCount: result?.data?.data?.items[0]?.comment_count,
          //     likeCount: result?.data?.data?.items[0]?.like_count,
          //     postImage: result?.data?.data?.items[0]?.carousel_media[0]?.image_versions?.items[0]?.url,
          //     timeStamp:
          //       result?.data?.data?.items[0]?.inline_composer_imp_trigger_time,
          //   },
          // );
